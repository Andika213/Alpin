...
|  \/  | __ )|  ___|%s {au:Andika}
%s| |\/| |  _ \| |_%s    {ig:@andika_12124123}
%s| |  | | |_) |  _|%s   {gh:github.com/Andika213}
%s|_|  |_|____/|_|%s     {yt:youtube.com/GF Alia}
"""%(M,P,M,P,U,P,U,P))
# Proxy
try:
    ___res = requests.get('https://api.proxyscrape.com/v2/?request=displayproxies&protocol=socks4&timeout=10000&country=all&ssl=all&anonymity=all').text
